...
|---------|-------|----------|
| [F0023 — Global Search, Saved Views & Operational Reporting](./F0023-global-search-saved-views-and-operational-reporting/README.md) | CRM Release MVP | Provides cross-object findability, operational visibility, and daily management reporting required for adoption. Pulled to the front of Next (2026-06-06): it is the search/reporting substrate that F0008 insights and F0037 rollups depend on, and it surfaces F0017's new hierarchy/territory dimensions. |
| [F0037 — Hierarchy-Aware Access Scoping & Distribution Rollups](./F0037-hierarchy-aware-access-scoping-and-distribution-rollups/README.md) | CRM Release MVP+ | Promoted Later→Next (2026-06-06, operator decision), sequenced immediately after F0023. Homes the scope deferred from F0017 (plan run `2026-06-06-5fb353e9`): hierarchy-aware access-control enforcement + distribution rollup reporting. **Placeholder — needs its own `plan` run before build**; can only start once F0017 (Now) is delivered and F0023 is underway. |
