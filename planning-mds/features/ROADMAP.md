...
|---------|-------|-----------|
| [F0041 — Neuron Contextual Intent Adjudicator (gated follow-on)](./F0041-neuron-contextual-adjudicator/README.md) |  |  |
...
| [F0039 — Neuron Durable Conversations & Local Phi Intent Resolution](./archive/F0039-neuron-multi-thread-conversations/README.md) | Neuron Companion | Done and archived (2026-07-25, feature run `2026-07-25-273d5672`) — 8 stories: durable conversation store, owner-scoped thread and history API, conversation-first panel, structured provider with a verified local Phi profile, intent catalog and prompt registry, deterministic preflight and one-call direct resolver, dispatcher persistence and provenance integration, and evaluation with shadow mode and rollout gating. Ships in shadow mode: the §30.4 rollout gate is red on routing accuracy (all security gates green), so direct Phi routing is withheld. The gated ninth story was promoted to F0041. |
...
| [F0040 — Neuron Second Specialist Head — Broker Activity](./archive/F0040-neuron-second-specialist-head/README.md) | Neuron Companion | Done and archived (2026-09-03, feature run 2026-09-01-fd408477, squash merge ef550a6) |
