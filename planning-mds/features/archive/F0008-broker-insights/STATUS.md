...
| Architect | Yes | ADR-029 implementation and KG binding reconciliation require architecture approval. | Architect | 2026-07-03 |
...
- Governing ADR: `planning-mds/architecture/decisions/ADR-029-broker-insights-read-models.md`.
