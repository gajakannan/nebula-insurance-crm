...
- PLAN_REVIEW_RUN_FOLDER: `planning-mds/operations/evidence/2026-05-26-aaa8bd7c/` (base run path per §8; NOT under a feature evidence root)
...
| `PLAN_REVIEW_RUN_ID` | `2026-05-26-aaa8bd7c` |
| `PLAN_REVIEW_RUN_FOLDER` | `planning-mds/operations/evidence/2026-05-26-aaa8bd7c/` |
...
- Writing into any feature evidence package (`{FEATURE_EVIDENCE_ROOT}/`).
