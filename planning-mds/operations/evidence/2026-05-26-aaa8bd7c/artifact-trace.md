...
This run folder only (`planning-mds/operations/evidence/2026-05-26-aaa8bd7c/`):
...
- Prior plan run `planning-mds/operations/evidence/2026-05-23-41109356/` (F0035) and `2026-05-25-51ff2a92/` (F0036) — referenced as the subject plan's provenance only; findings re-derived from raw artifacts, not from these summaries.
