...
- PLAN_RUN_FOLDER: `planning-mds/operations/evidence/2026-05-25-51ff2a92/` (base run path per §8; NOT under a feature evidence root)
...
| `FEATURE_EVIDENCE_ROOT` | `planning-mds/operations/evidence/F0036-dynamic-product-attribute-form-engine` (NOT created during plan) |
| `PLAN_RUN_ID` | `2026-05-25-51ff2a92` |
| `PLAN_RUN_FOLDER` | `planning-mds/operations/evidence/2026-05-25-51ff2a92/` |
...
- Creating any feature evidence package at `{FEATURE_EVIDENCE_ROOT}/` (feature-action territory)
