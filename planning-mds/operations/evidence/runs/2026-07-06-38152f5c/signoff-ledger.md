...
|------|----------|---------|----------|
| Architect | Yes | PASS | `g0-assembly-plan-validation.md` |
...
All required role evidence is present under `planning-mds/operations/evidence/runs/2026-07-06-38152f5c`.
...
- Dependency, secrets, SAST, and DAST scans are waived as documented in `evidence-manifest.json` because this is a static sidebar navigation follow-up with no dependency, auth, policy, data-access, or input-handling change.
