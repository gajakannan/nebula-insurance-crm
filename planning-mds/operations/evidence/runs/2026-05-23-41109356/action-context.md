...
- PLAN_RUN_FOLDER: `planning-mds/operations/evidence/runs/2026-05-23-41109356/` (base run path per §8; NOT under a feature evidence root)
...
| `FEATURE_INDEX_ROOT` | `planning-mds/operations/evidence/features/F0035-session-continuity-and-token-refresh` (not created during plan) |
| `PLAN_RUN_ID` | `2026-05-23-41109356` |
| `PLAN_RUN_FOLDER` | `planning-mds/operations/evidence/runs/2026-05-23-41109356/` |
...
- Creation of any feature completion run package under `planning-mds/operations/evidence/runs/{RUN_ID}/` (that belongs to feature action)
