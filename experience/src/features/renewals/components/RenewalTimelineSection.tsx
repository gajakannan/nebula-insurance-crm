...
import { useRenewalTimeline } from '../hooks/useRenewalTimeline';

interface RenewalTimelineSectionProps {
  renewalId: string;
}

export function RenewalTimelineSection({ renewalId }: RenewalTimelineSectionProps) {
  const {
    data,
    isLoading,
    isError,
