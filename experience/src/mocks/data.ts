  ...
  notifications: [
    {
      ...
      message: 'New broker Blue Horizon Risk Partners has been created.',
      notificationType: 'BrokerCreated',
      isRead: false,
      readAt: null,
      linkedEntityType: 'Broker',
      linkedEntityId: 'broker-1',
    ...
    },
    {
      ...
      message: 'Submission for Acme Corp has been received.',
      notificationType: 'SubmissionReceived',
      isRead: false,
      readAt: null,
      linkedEntityType: 'Submission',
      linkedEntityId: 'sub-1',
      createdAt: new Date(Date.now() - 5 * 60 * 60 * 1000).toISOString(),
    },
    {
      id: 'notif-3',
      title: 'Task overdue',
      message: 'Follow up on broker submission package is overdue.',
    ...
    },
    {
      ...
      message: 'Opportunity has progressed to quoting stage.',
      notificationType: 'OpportunityUpdate',
      isRead: true,
    ...
    },
    {
      ...
      message: 'Data sync completed with warnings.',
